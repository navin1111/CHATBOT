...
export default function Home() {
  ...
  return (
    <div className="w-full flex flex-col h-screen items-center bg-[#f0e9e1] react-textarea">
      ...
      <div className="w-[70%] h-[30%] flex flex-col justify-center items-center">
        <div className="w-full flex flex-col justify-center items-center">
          <span className="text-5xl font-serif react-textarea">Hello all, This is Navin</span>
        </div>
        <br />
        <div className="w-[70%] h-[25%] rounded-xl react-textarea flex items-center justify-center border border-slate-300 bg-[#F8F8F7] px-2 py-2">
