    ...
    <div className="w-full flex flex-col h-screen items-center bg-[#f0e9e1] react-textarea
     ">
      ...
      <div className="w-[70%] h-[30%] flex flex-col pt-50 justify-center items-center ">
        ...
        <br />
        <div className="w-[70%] h-[25%] rounded-xl react-textarea flex items-center justify-center border border-slate-300 gap-2   p-1flex  rounded-md  bg-background px-1 py-1  ">
         <LandingInput/>
        </div>
      </div>
    </div>
